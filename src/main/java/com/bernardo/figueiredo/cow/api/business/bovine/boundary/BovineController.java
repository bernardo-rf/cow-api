...
public class BovineController {
    ...
    @ApiOperation("Get bovines by idOwner")
    public ResponseEntity<List<BovineFullInfoDTO>> getBovinesToAuction(@PathVariable String userWallet)
            throws Exception {
        try {
    ...
    public ResponseEntity<BovineDTO> updateBovine(@PathVariable long bovineId, @RequestBody BovineDTO bovineDTO)
            throws Exception {
        try {
