...
public interface BovineRepository extends JpaRepository<Bovine, Long> {
    ...
    @Query( value ="WITH temp(id_bovine,id_bovine_parent1, id_bovine_parent2, active, birth_date, breed, color, height, " +
            "id_contract, id_field, observation, serial_number, weight, gender, id_user, imagecid) as " +
            "(SELECT S.id_bovine, S.id_bovine_parent1, S.id_bovine_parent2, S.active, S.birth_date, S.breed, S.color, " +
            "S.height, S.id_contract, S.id_field, S.observation, S.serial_number, S.weight, S.gender, S.id_user, S.imagecid " +
            ...
            "S2.height, S2.id_contract, S2.id_field, S2.observation, S2.serial_number, S2.weight, S2.gender, S2.id_user, S2.imagecid " +
            ...
            "S3.height, S3.id_contract, S3.id_field, S3.observation, S3.serial_number, S3.weight, S3.gender, S3.id_user, S3.imagecid " +
