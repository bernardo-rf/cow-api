...
public class UserDTO {
    ...
    public UserDTO(long idUser, String idContract, String idWallet, int idUserType, String type, String name,
                   Date birthDate, String email, String password, Boolean active) {
        this.idUser = idUser;
